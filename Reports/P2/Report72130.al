report 72130 "R6631 Sales - RetOrderConf DCR"
{
    ...
    dataset
    {
        dataitem(SalesHdr; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                column(SalesReturnOrderConfirmationTitle; STRSUBSTNO(Trl('SalesReturnOrderConfirmation%1'), wgCopyText))
                {
                }
    ...
    requestpage
    {
        ...
        begin
            ...
            wgLogInteraction := wgCduSegManagement.FindInteractTmplCode(18) <> '';
    ...
    trigger OnPreReport();
    begin
        if CurrReport.USEREQUESTPAGE = false then begin
            wgLogInteraction := wgCduSegManagement.FindInteractTmplCode(18) <> '';
            wgNoOfCopies := 0;
        end;
    end;
    ...
    procedure InitializeRequest(pShowInternalInfoFrom: Boolean; pLogInteractionFrom: Boolean);
    begin
